...
import { Mail, ArrowRight, Send, Star, MessageSquare } from "lucide-react";
            ...
            >
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="flex w-full items-center justify-center gap-2 rounded-lg bg-gradient-primary px-6 py-3 text-sm font-semibold text-primary-foreground transition-all hover:shadow-neon"
                  >
