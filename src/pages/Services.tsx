...
const services = [
  {
    ...
    description: "High-performance Shopify stores built from scratch — custom themes, headless commerce, and enterprise-grade architecture.",
  },
  {
    icon: Share2,
    title: "Social Media Marketing",
    description: "Full-funnel social strategies across Instagram, Facebook, TikTok, and Pinterest to build brand awareness and drive sales.",
  },
  {
    icon: Palette,
    title: "Web Designing",
    description: "Conversion-optimized UI/UX design with premium aesthetics. Every pixel crafted to maximize engagement and trust.",
  },
  {
    icon: Target,
    title: "Search Engine Marketing (SEM)",
    description: "Google Ads, Shopping campaigns, and Performance Max strategies engineered for maximum ROAS and profitable acquisition.",
  },
  {
    icon: Search,
    title: "Search Engine Optimization (SEO)",
    description: "Technical SEO audits, content strategy, link building, and schema markup to dominate organic search results.",
  },
  {
    icon: ShieldCheck,
    title: "Reputation Management",
    description: "Proactive brand monitoring, review management, and crisis response to protect and elevate your online reputation.",
  },
];
      ...
      <section className="bg-section-alt py-24">
        <div className="container mx-auto px-6">
          ...
          <p className="mx-auto mb-14 max-w-2xl text-center text-muted-foreground">
            A holistic system that covers every touchpoint of your e-commerce funnel — from discovery to retention.
          </p>
          ...
          <div className="grid items-center gap-12 md:grid-cols-2">
            ...
            >
              ...
              <p className="mb-6 text-muted-foreground leading-relaxed">
                Google Merchant Center is the gateway to Google Shopping, free product listings, and Performance Max campaigns. Without approval, your products are invisible to millions of high-intent shoppers. Most stores get rejected — and don't know how to fix it.
              </p>
              <p className="mb-6 text-muted-foreground leading-relaxed">
                We specialize in diagnosing and resolving Merchant Center suspensions, policy violations, and feed optimization issues that keep your store locked out.
              </p>
      ...
      <section className="bg-section-alt py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="mx-auto mb-8 max-w-xl text-muted-foreground">
            Let's build a growth engine tailored to your brand.
          </p>
          <Link
            to="/contact"
